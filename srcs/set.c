...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/06/20 15:01:07 by lbrochar          #+#    #+#             */
/*   Updated: 2023/06/20 15:53:14 by lbrochar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	set_img(t_data *data)
{
	data->img.height = 80;
	data->img.width = 80;
	data->img.floor = "./images/floor.xpm";
	data->img.wall = "./images/wall.xpm";
	data->img.collect = "./images/item.xpm";
	data->img.player = "./images/player.xpm";
